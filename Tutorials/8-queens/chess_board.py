    ...
    def show_state(self, c):
        ...
        for i, l in enumerate(c):
            ...
            if self.image is None:
                ...
                self.scatter_handle.append(self.plax.add_artist(AnnotationBbox(OffsetImage(self.image), (
                l % self.size + 0.05 * offset, int(l / self.size) + 0.05 * offset), frameon=False)))
