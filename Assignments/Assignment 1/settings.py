...
game_settings = {
   ...
   "dictionary": 'deutsch',   # 'english' or  'francais' or 'deutsch' or 'italiano' or 'espanol'

   "wordLength": 5,

   "numberOfGuesses": 6, # number of guesses per game

   "numberOfGames": 1000, # total number of games played
   ...
   "seed": 1337   # seed for random choices of words in the game, None for random seed
